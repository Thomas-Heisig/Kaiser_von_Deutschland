...
Schalten Sie Ihr Diskettenlaufwerk ein und legen Sie die Kaiser II Diskette mit der ersten Seite (Etikett nach oben) ein. Nun können Sie den Computer einschalten. Erscheint die Meldung "KAISER II, BOOTE ERSTE SEITE" so müssen Sie die Diskette umdrehen und eine beliebige Funktionstaste drücken (z. B. START). Der Bildschirm wird nun schwarz und das Spiel wird geladen. Wenn das Titelbild erscheint, können Sie sich die Musik bis zum Ende anhören oder sie mit dem Feuerknopf des Joysticks in Port 1 abbrechen.	kaiserpic2.png
